																	...
																	<div class="col-xl-9">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control" name="typeName" type="text" required="true" value="{{$type->name}}" />
                                                                                    <input class="form-control" name="typeId" type="hidden" value="{{($type->id) ? $type->id : 0}}" />
																				</div>
																			</div>
																			<!--end::Group-->
