																	...
																	<div class="col-xl-9">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control" name="locationName" type="text" required="true" value="{{$location->name}}" />
                                                                                    <input class="form-control" name="locationId" type="hidden" value="{{($location->id) ? $location->id : 0}}" />
																				</div>
																			</div>
																			<!--end::Group-->
