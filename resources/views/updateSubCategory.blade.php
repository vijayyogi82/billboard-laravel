																	...
																	<div class="col-xl-9">
                                                                            ...
                                                                            <div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control" name="subCatName" type="text" required="true" value="{{$subCategory->name}}" />
                                                                                    <input class="form-control" name="subCatId" type="hidden" value="{{($subCategory->id) ? $subCategory->id : 0}}" />
																				</div>
																			</div>
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<select name="category" class="form-control" required>
                                                                                        ...
                                                                                        @foreach($category as $catRow)
                                                                                            <option value="{{$catRow->id}}" {{$subCategory->category == $catRow->id ? 'selected' : ''}}>{{$catRow->name}}</option>
                                                                                        @endforeach
                                                                                    </select>
																				</div>
																			</div>
																				...
																				<div class="col-lg-9 col-xl-9">
																					<select name="type" class="form-control" required>
                                                                                        ...
                                                                                        @foreach($type as $typeRow)
                                                                                            <option value="{{$typeRow->id}}" {{$subCategory->type == $typeRow->id ? 'selected' : ''}}>{{$typeRow->name}}</option>
                                                                                        @endforeach
                                                                                    </select>
																				</div>
																			</div>
