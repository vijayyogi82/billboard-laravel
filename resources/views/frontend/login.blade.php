                                    ...
                                    <div class="form-wrap">
                                        ...
                                        <ul>
                                            ...
                                            <div class="user-login-code" style="height: 42px;">
                                                <a href="./sub-login.html"><button type="button" class="button common-form-btn sent-otp" id="btn-common-form">Enter Login Code</button></a>
                                            </div>
                                            ...
                                            <li>
                                                <div class="btn-wrap">
                                                    <a href="./otp-message.html" ><button type="button" class="button common-form-btn sent-otp">Next<img src="asset/images/icon/single-arrow.svg" style="width: 13px;"/></a></button>
                                                    <p>Don’t have an account?</p>
                                                    <a href="./sign-up-mediaowner.html">Create Account</a>
                                                </div>
                                            </li>                                       
                                        </ul>
                                    </div>
