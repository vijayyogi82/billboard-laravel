                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="box-container">
                            <a href="./otp-mobile.html">  <div class="call-box">
                                <img src="./asset/images/🦆 icon _1telephone phone mobile cellphone_.svg">
                             </div></a>
                            <div class="mail-box1">
                                <img src="./asset/images/🦆 icon _whiteemail_.svg" />
                                <p>selected</p>
                        ...
                        <div class="otp-send">
                            <h2>OTP Sent !</h2>
                            <p>Please enter the 4 digit OTP sent to your E-mail ID.</p>
                            <div class="input-box">
