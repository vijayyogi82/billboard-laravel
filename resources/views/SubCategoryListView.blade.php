                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{isset($row['type']['name']) ? $row['type']['name'] : ''}}</td>
                                                                        <td>
                                                                            @if($row['status'] == 0)
                                                                                <a href="{{url('update-sub-category-status/'.$row['id'].'/1')}}" class="btn btn-danger">In-Active</a>
                                                                            @else
                                                                                <a href="{{url('update-sub-category-status/'.$row['id'].'/0')}}" class="btn btn-success">Active</a>
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            <a href="{{url('update-sub-category/'.$row['id'])}}" class="btn btn-info">Edit</a>
                                                                        </td>
                                                                    </tr>
                                                                    @php 
                                                                    $i++;
